...
!           real(dl), parameter :: G=6.6742e-11_dl
           ...
           adotoa = 1./(a*dtauda(a))
           w_de_dot = 3. * adotoa * p0/grhode(a) * (1. + w_de(a) )
         ...
         !Not tested for non-adiabatic         
           ...
           if (.not. EV%no_rad_multpoles .and. tauend > tau_switch .and. DoLateRadTruncation &
              ...
              if (CP%Num_Nu_massive == 0) then
                 ...
                 if ( (w_lam /= -1 .and. w_Perturb) .or. CP%do_affine_eos) then
...
! ------ :D
        ...
        if (CP%do_affine_eos) grhov_t = grhode(a)*a2
! ---
...
! ------ :D
        ...
        if (CP%do_affine_eos) gpres=(grhog_t+grhor_t)/3+grhov_t*w_de(a)
! ---
...
! ------ :D
        ...
        if (CP%do_affine_eos) gpres=(grhog_t+grhor_t)/3._dl+grhov_t*w_de(a) 
! ---
