...
! ------ :D 2007 1st Dec, Davide modification
       ...
       if (P%do_barotropic_sos .and. P%do_affine_eos) cs2_lam = P%alpha
       if (P%do_barotropic_sos .and. P%do_affine_eos==.false.) cs2_lam = w_lam
!!$       write(*,*) " Inidriver.F90: cs2_lam = ", cs2_lam
! ---
