!! May 2009 Oliver. The second quasi-exponential mdoel. Hope it'll be better than the first one. 
!!
!!
...
! ------ :D
            P%do_affine_eos     = .false.
! --- Mar 2009
            P%do_exp_eos        = .false.
            P%do_barotropic_sos = .false.
! --- Apr 2009 :-O
            P%do_qexp_eos       = .false.
